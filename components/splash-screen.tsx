...
import {
  markSplashReady,
  useSplashDocumentScrollLock,
} from "@/components/splash-ready"
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <motion.h1
                  className="bg-[linear-gradient(115deg,var(--foreground),var(--primary),color-mix(in_oklch,var(--primary)_50%,var(--foreground)))] bg-clip-text font-heading text-4xl leading-tight font-semibold text-transparent sm:text-6xl"
              ...
              >
                ...
                <div className="flex items-center justify-between text-[0.68rem] font-medium tracking-[0.22em] text-muted-foreground uppercase">
                  <span>Loading</span>
                  <span>{progress}%</span>
                </div>
              </motion.div>
